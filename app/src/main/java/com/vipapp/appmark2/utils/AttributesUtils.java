...
import static com.vipapp.appmark2.utils.Const.gravity_string_to_int;
...
public class AttributesUtils {
    ...
    private static void valueToDrawable(String value, Res resources, PushCallback<Drawable> callback){
        ImageUtils.load(resources.get(value), result ->
                callback.onComplete(new BitmapDrawable(com.vipapp.appmark2.utils.wrapper.Res.get(), result)));
    }
