...
import static com.vipapp.appmark2.utils.Const.JAVA_LANGUAGE;
import static com.vipapp.appmark2.utils.Const.MAX_LINES_IN_TEXT_EDITOR;
import static com.vipapp.appmark2.utils.Const.SYMBOL_INSERTED;
                        ...
                        if (current_char == '.') {
                            ...
                            if(!current_class.contains(".")) {
                                ...
                                Classes.get(classItems -> {
                                    // getting only items with current_class name
